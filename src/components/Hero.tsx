        ...
        <section className="font-exo2 relative bg-white pt-12 pb-20 overflow-hidden" style={{ backgroundImage: "url('/hero_bg.png')" }}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center space-x-2 bg-white border border-[#32b6d4] px-5 py-2 rounded-full text-sm">
                ...
                <div className="text-center max-w-6xl mx-auto mb-12">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center mb-5">
                        <img src="./hero4.png" alt="Capterra_Logo" className="w-[25%] h-auto" />
                    </div>

                    {/* CTA Buttons */}
                    <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
                        <img src="./chrome.png" alt="CTA_Buttons" className="w-[20%] h-auto" />
                        <img src="./chrome1.png" alt="CTA_Buttons" className="w-[20%] h-auto" />
                    </div>
                </div>
            </div>
        </section>
